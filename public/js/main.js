...
const getInfo = async(event) => {
    ...
    if(cityVal === ""){
      ...
      datahide2.classList.add('data_hide');
        ...
        try{
            let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=c79bcd1f56ab0937e8d537b71c27d83d`;
            ...
            let url2 = `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&exclude=hourly,minutely&units=metric&appid=c79bcd1f56ab0937e8d537b71c27d83d`;
